...
#
# NodeConn: an object which manages p2p connectivity to a termucash node
...
COIN = 100000000 # mlumin 5/2021: In terms of Termucash, 1 termucash or 100,000,000 aldian.
...
# Objects that map to termucashd objects, which can be serialized/deserialized
...
class CTransaction(object):
    ...
    def deserialize(self, f):
        ...
        if len(self.vin) == 0:
            ...
            # matches the implementation in termucashd
            if (flags != 0):
                self.vin = deser_vector(f, CTxIn)
...
class msg_headers(object):
    ...
    def deserialize(self, f):
        # comment in termucashd indicates these should be deserialized as blocks
...
class NodeConn(asyncore.dispatcher):
    ...
    def __init__(self, dstaddr, dstport, rpc, callback, net="regtest", services=NODE_NETWORK, send_version=True):
        ...
        print('MiniNode: Connecting to Termucash Node IP # ' + dstaddr + ':' \
            + str(dstport))
