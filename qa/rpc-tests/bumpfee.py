...
class BumpFeeTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        test_termucash_wallet_minchange(rbf_node, dest_address)
...
def test_settxfee(rbf_node, dest_address):
    # Termucash: Increment is fixed, so this test tests for settxfee not making a difference
...
def test_termucash_wallet_minchange(rbf_node, dest_address):
