...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s termucash-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  termucash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded termucash transaction") + "\n" +
              "  termucash-tx [options] -create [commands]   " + _("Create hex-encoded termucash transaction") + "\n" +
              "\n";
