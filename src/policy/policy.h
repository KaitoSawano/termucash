...
/** Recommended transaction fee by Termucash Core developers
  *
 ...
 *
 *  Termucash:    Increment mempool limits and accept RBF in steps of 0.0001 TERM
...
/**
 * Termucash: Default dust limit that is evaluated when considering whether a
...
/**
 * Termucash: Default hard dust limit that is evaluated when considering whether
