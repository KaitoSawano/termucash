...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the Termucash Core repository on GitHub"),
        tr("Services that claim to double your termucashs are always ponzi schemes")
    };
