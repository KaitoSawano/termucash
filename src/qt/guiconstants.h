...
#define QAPP_ORG_NAME "Termucash"
#define QAPP_ORG_DOMAIN "termucash.org"
#define QAPP_APP_NAME_DEFAULT "Termucash-Qt"
#define QAPP_APP_NAME_TESTNET "Termucash-Qt-testnet"
