    ...
    platformStyle(_platformStyle)
{
    ...
    // Termucash: load fallback font in case Comic Sans is not available on the system
    ...
    // Termucash: load this bundled font for Settings -> Options in case it's not available on the system
    ...
    // Termucash: Specify Comic Sans as new font.
    QFont newFont("Comic Sans MS", 10);

    // Termucash: Set new application font
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Termucash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and termucash: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Termucash addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Termucash addresses"));
    ...
    openAction->setStatusTip(tr("Open a termucash: URI or payment request"));

    importPrivateKeyAction = new QAction(platformStyle->TextColorIcon(":/icons/address-book"), tr("&Import Private Key..."), this);
    importPrivateKeyAction->setStatusTip(tr("Import a Termucash private key"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Termucash command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Termucash network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
{
    QString strTitle = tr("Termucash"); // default title
