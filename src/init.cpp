...
void Shutdown()
{
    ...
    RenameThread("termucash-shutoff");
    ...
    StopHTTPServer();
#ifdef ENABLE_WALLET
    // Termucash 1.14 TODO: ShutdownRPCMining();
    if (pwalletMain)
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/termucash/termucash>";
    const std::string URL_WEBSITE = "<https://termucash.com>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("termucash-loadblk");
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // Termucash: Do we need to do any RPC mining init here?
